...
```r
# Ducks that have a "Long" migratory strategy have a relatively lower average body mass than ducks with any other migratory strategy
```
...
```r
# Question: Do omnivores have a higher average mean eggs per clutch than vegetarians?
